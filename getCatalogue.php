...
if (!$result = $db->query($sqlSelect)) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo  "</td><td>$" . $row["value"] . "</td><td>" . $row["valDetermined"]  . "</td><td>" . $row["valDeterminedOther"] . "</td><td><a href='" . $imageFile . "' target='_blank'><img src='" . $imageFile . "' width='30' height='30' class='img-rounded' ></a></td><td>" . $cleanDate->format('m/d/y') . "</td>";
        echo "</tr>";
    }
}
          $db->close();
